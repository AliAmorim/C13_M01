...
principal: while (continuar == 'sim') {
  ...
  if (escolha == 1) {
    ...
    if (escolha == 3) {
      console.log('Você tentou atravessar correndo mas acabou sendo atropelado')
      console.log()
      console.log('Seu status atual')
      morte()
      console.log()
  ...
  console.log('Com todas essas informações está na hora da sua escolha final… ')

  console.log()

  console.log('------------------ QUEM É O ASSASINO?-------------------------')
